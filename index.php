<?php 
  ...
  if (isset($_SESSION['id'])){
    // if (isset($_POST['produk']) and isset($_POST['user'])){
    //   $x=addslashes($_POST['produk']);
    //   $y=addslashes($_POST['user']);
    //   mysqli_query($conn,"insert into checkout values('$y','$x')");
...
<body id="page-top">
      ...
      <div id="content">
              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                <form class="form-inline mr-auto w-100 navbar-search">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-primary" type="button">
                        <i class="fas fa-search fa-sm">;lkjlkjlkjl;</i>
                      </button>
                    </div>
                  </div>
                </form>
        ...
        <div class="wrapper">
          <div class="product-sec1">
            <h4 class="heading-tittle" style="font-family: cursive;color: deepskyblue; text-align: center;">TEMAN YANG MUNGKIN ANDA SUKA</h4>
            <div class="grid-container">
            <div class="row">
            <?php for($z=count($produc); $z>(count($produc)-4); $z--): ?>
            <div class="col-md-3">
          ...
          <!-- first section -->
          <div class="product-sec1">
            <h4 class="heading-tittle" style="font-family: cursive;color: deepskyblue; font-size: 20px; font-weight: bold;">Teman</h4>
            <div class="grid-container">

            <div class="row">
            <?php foreach ($data as $key): ?>
            <div class="col-md-4">
            <div class="grid-item product-men" style="width: 33.3%; float: left;">
              <div class="men-pro-item simpleCart_shelfItem">
                <div class="men-thumb-item">
                  <img src="img/<?php echo $key['id'].".jpg"; ?>" alt="" style="width: 275px; height: 183px;">
                  <div class="men-cart-pro">
                    <div class="inner-men-cart-pro">
  ...
  <?php for($z=count($produc); $z>(count($produc)-3); $z--): ?>
